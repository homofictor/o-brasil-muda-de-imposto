(function(){
 ...
 function refreshAutomation(){
  ...
  const treatment=window.sectorSuggestion?.treatmentReview?'Revisar NCM/cClassTrib':(mix||'A revisar');
 ...
 function refreshReview(){
  ...
  if(window.sectorSuggestion?.treatmentReview)notes.push('O CNAE indica comércio de produtos médico-hospitalares. Confirme o tratamento das receitas por NCM/cClassTrib, pois o CNAE sozinho não define redução ou alíquota zero de IBS/CBS.');
