...
function modelForYear(year){
  ...
  const sr=simplesRate(annex,rbt12,year),share=dasConsumptionShare(annex,sr.idx,year),das=annualRevenue*sr.effective;
  ...
  // O crédito das compras depende das aquisições, não do tratamento tributário das vendas. Na ausência do mix fiscal dos insumos, usa-se a alíquota regular cheia do ano como cenário-base.
