...
function modelForYear(year){
 ...
 const legacyKnown=year>=2033||hasFieldValue('legacyRate'),legacy=annualRevenue*clamp(num('legacyRate')/100,0,.40)*legacyTransition(year),presumedTotal=netVat+irpj+csll+cpp+legacy+fullCompliance,presumedValid=cppBaseKnown&&legacyKnown;
 ...
 const realIrpj=realProfitKnown?(realIrpjBase*.15+Math.max(0,realIrpjBase-240000)*.10):0,realCsll=realProfitKnown?realCsllBase*.09:0,realTotal=netVat+realIrpj+realCsll+cpp+legacy+fullCompliance,realValid=realProfitKnown&&cppBaseKnown&&legacyKnown;
 ...
 const allModels=[
  ...
  {key:'presumed',name:'Lucro Presumido',total:presumedTotal,tax:presumedTotal-fullCompliance,credit:regularClientCredit,compliance:fullCompliance,valid:presumedValid,validationMessage:presumedValid?'':(!cppBaseKnown?'Informe a remuneração mensal sujeita à contribuição patronal.':'Informe a carga efetiva atual de ICMS/ISS para a transição de 2027 a 2032.')},
  {key:'real',name:'Lucro Real',total:realTotal,tax:realTotal-fullCompliance,credit:regularClientCredit,compliance:fullCompliance,valid:realValid,validationMessage:realValid?'':(!realProfitKnown?'Informe ou importe o lucro contábil antes de IRPJ e CSLL.':!cppBaseKnown?'Informe a remuneração mensal sujeita à contribuição patronal.':'Informe a carga efetiva atual de ICMS/ISS para a transição de 2027 a 2032.')}
 ];
