...
function renderReferenceComparison(all){
  ...
  mobile.innerHTML=card('Referência atual','Parcela do DAS ligada aos tributos substituídos',[['CBS / federais',moneyPct(cur.cbs,y27.annualRevenue)],['IBS / ICMS-ISS',moneyPct(cur.ibs,y27.annualRevenue)],['Débito bruto',moneyPct(cur.gross,y27.annualRevenue)],['Crédito sobre insumos','—'],['Carga líquida',moneyPct(cur.net,y27.annualRevenue)]])+card('2027','Início da cobrança regular',[['CBS',moneyPct(c27,y27.annualRevenue)],['IBS',moneyPct(i27,y27.annualRevenue)],['Débito bruto',moneyPct(y27.grossVat,y27.annualRevenue)],['Crédito sobre insumos',moneyPct(y27.inputCredit,y27.annualRevenue)],['Carga líquida',moneyPct(y27.netVat,y27.annualRevenue)]],true)+card('2033','Regime pleno',[['CBS',moneyPct(c33,y33.annualRevenue)],['IBS',moneyPct(i33,y33.annualRevenue)],['Débito bruto',moneyPct(y33.grossVat,y33.annualRevenue)],['Crédito sobre insumos',moneyPct(y33.inputCredit,y33.annualRevenue)],['Carga líquida',moneyPct(y33.netVat,y33.annualRevenue)]]);
}
